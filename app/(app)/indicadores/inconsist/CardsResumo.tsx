...
export function CardsResumoInconsist({ r }: { r: ResumoInconsist }) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
      <Kpi icon={Users}          label="Colaboradores"       value={r.colaboradores.toLocaleString('pt-BR')}    color="orange" />
      <Kpi icon={AlertTriangle}  label="Total inconsistências" value={r.totalInconsist.toLocaleString('pt-BR')} color="rose" />
