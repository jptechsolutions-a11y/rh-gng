...
create table escuta_reunioes (
  ...
  total_presentes int generated always as (
    (select count(*)::int from jsonb_array_elements(presenca) e
...
export const escutaReunioes = pgTable('escuta_reunioes', {
  ...
  totalPessoas:    integer('total_pessoas'),
...
export async function listarReunioes(filtro?: {
  ...
  return db.select({
    ...
    totalPresentes: schema.escutaReunioes.totalPresentes,
    totalPessoas: schema.escutaReunioes.totalPessoas,
